...
export default function Home(){
  ...
  return <main className="dashboardSite">
    <header className={`dashboardHeader compactHeader ${menuOpen?'menuOpen':''}`}>
      ...
      {session?<button className="loginButton" onClick={()=>gate('My Account')}>♙ Account</button>:<div className="authHeaderActions"><button className="loginButton" onClick={()=>gate('Welcome back')}>LOGIN</button><button className="joinButton" onClick={()=>gate('Create your free account')} >LOG IN / SIGN UP</button></div>}
